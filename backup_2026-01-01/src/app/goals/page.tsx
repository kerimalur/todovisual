      ...
      <div className="space-y-3">
        {sortedGoals.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center border border-dashed border-gray-200 rounded-xl bg-white">
            ...
            <p className="font-medium text-gray-700 mb-1">Noch keine Ziele</p>
            <p className="text-sm text-gray-500 mb-4">Definiere dein erstes Ziel, um loszulegen.</p>
            <button onClick={() => openGoalModal()} className="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white text-sm font-medium rounded-xl shadow-sm hover:shadow-md transition-all">
              <Plus size={16} />
              Ziel erstellen
            </button>
          </div>
